...
public class LoggerTest {
    ...
    public void battleTest() {
        ...
        verify(log, times(2)).updateDamage(entity, entity2);
        verify(log, times(1)).updateDamage(entity2, entity);
    ...
    public void battleTestFightWizardAstralBall() {
        ...
        verify(log, times(2)).updateDamage(character1, character2);
        verify(log, times(1)).updateDamage(character2, character1);
